...
def get_config():
    from semilearn.os_algorithms.utils import str2bool
    ...
    parser.add_argument('-os_alg', '--os_algorithm', type=str, default='bdmatch', help='open-set ssl algorithm')
    ...
    # add open-set algorithm specific parameters
    for argument in name2osalg[args.os_algorithm].get_argument():
